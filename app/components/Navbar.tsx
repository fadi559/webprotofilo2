...
export default function Navbar() {
  ...
  useEffect(() => {
    if (!isMobileMenuOpen && pendingScrollTo) {
  ...
  }, [isMobileMenuOpen, pendingScrollTo])
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            className="md:hidden bg-gray-900/95 backdrop-blur-md z-50 fixed top-16 left-0 right-0"
